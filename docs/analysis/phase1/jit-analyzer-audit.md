...
| **P2** | ✅ Add `DynamicMethodFrameCount` — detect dynamic-module frames and surface a dedicated count and finding | Medium — dynamic codegen is a common code-heap growth cause | Low | Medium | Improvement |
