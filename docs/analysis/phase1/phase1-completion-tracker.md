...
| **P1 Implemented** | 56 |
| **P2 Implemented** | 12 |
| **Overall P0+P1 Rate** | 46.2% (96/208) |
...
|---|----------|----|----|----|----|-------|
| 18 | **ThreadAnalyzer** | 2/3 | 3/4 | 0/8 | 0/4 | P0-1,P0-2 done; P0-3 pending; P1-1,P1-2,P1-3 done; P1-4 pending |
...
**Subtotal: 16/21 P0 done, 17/35 P1 done, 11/45 P2 done** (in-progress pools)
...
| **P1 items implemented** | **45** | 32.4% |
| **Combined P0+P1 rate** | **55.8%** | (77/138) |
