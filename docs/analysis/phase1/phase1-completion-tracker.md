...
| **P1 Implemented** | 55 |
| **P2 Implemented** | 12 |
| **Overall P0+P1 Rate** | 45.7% (95/208) |
...
|---|----------|----|----|----|----|-------|
| 18 | **ThreadAnalyzer** | 2/3 | 2/4 | 0/8 | 0/4 | P0-1,P0-2 done; P0-3 pending; P1-1,P1-2 done; P1-3,P1-4 pending |
...
**Subtotal: 16/21 P0 done, 16/35 P1 done, 11/45 P2 done** (in-progress pools)
...
| **P1 items implemented** | **44** | 31.7% |
| **Combined P0+P1 rate** | **55.1%** | (76/138) |
