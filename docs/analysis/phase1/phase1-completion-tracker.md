...
|---|----------|----|----|----|----|-------|
| 18 | **ThreadAnalyzer** | 2/3 | 4/4 | 2/8 | 0/4 | P0-1,P0-2 done; P0-3 pending; ✅ P1 complete; P2-1,P2-2 done; P2-3,P2-4,P2-5,P2-6,P2-7,P2-8 pending |
...
**Subtotal: 16/21 P0 done, 18/35 P1 done, 13/45 P2 done** (in-progress pools)
