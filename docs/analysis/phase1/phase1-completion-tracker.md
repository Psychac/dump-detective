...
|---|----------|----|----|----|----|-------|
| 18 | **ThreadAnalyzer** | 2/3 | 4/4 | 0/8 | 0/4 | P0-1,P0-2 done; P0-3 pending; ✅ P1 complete (P1-1,P1-2,P1-3,P1-4) |
...
**Subtotal: 16/21 P0 done, 18/35 P1 done, 11/45 P2 done** (in-progress pools)
