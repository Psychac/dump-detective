...
| **P1 Implemented** | 110 |
| **P2 Implemented** | 22 |
| **Overall P0+P1 Rate** | 74.8% (175/234) |
...
|---|----------|----|----|----|----|-------|
| 13 | **WcfChannelAnalyzer** | 2/2 | 1/4 | 0/4 | 0/3 | ✅ P0 complete (2/2); P1-1 (ChannelFactory) done; P1-2/3/4 pending |
...
**Subtotal: 24/32 P0 done, 27/40 P1 done, 19/55 P2 done** (in-progress pools)
