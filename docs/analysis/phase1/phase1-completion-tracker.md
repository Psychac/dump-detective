...
| **P1 Implemented** | 53 |
| **P2 Implemented** | 12 |
| **Overall P0+P1 Rate** | 44.7% (93/208) |
...
|---|----------|----|----|----|----|-------|
| 18 | **ThreadAnalyzer** | 2/3 | 0/4 | 0/8 | 0/4 | P0-1,P0-2 done; P0-3 and all P1 pending |
...
**Subtotal: 16/21 P0 done, 14/35 P1 done, 11/45 P2 done** (in-progress pools)
...
| **Combined P0+P1 rate** | **53.6%** | (74/138) |
