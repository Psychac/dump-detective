...
| **P1 Implemented** | 119 |
| **P2 Implemented** | 23 |
| **Overall P0+P1 Rate** | 79.9% (187/234) |
...
| 15 | **GCRootAnalyzer** | 1/2 | 3/4 | 0/5 | 0/3 | ✅ P0-2, P1-2, P1-3 complete; P0-1 pending; P1-1,P1-4 pending |
...
**Subtotal: 21/27 P0 done, 23/32 P1 done, 20/50 P2 done** (in-progress pools)
...
| Analyzers with partial P0+P1 completion | 14 | Some items done, some pending (includes GCRootAnalyzer P0-2/P1-2/P1-3 done, AsyncTaskAnalyzer, LeakCandidateAnalyzer, CrashAnalyzer, CollectionAnalyzer, StringAnalyzer, StaticRootLeakDetector, and others) |
...
| **P1 items implemented** | **119** | 76.3% |
| **Combined P0+P1 rate** | **79.9%** | (187/234) |
