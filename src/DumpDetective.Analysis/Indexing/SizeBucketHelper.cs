...
/// <summary>
/// Eight logarithmic size buckets used to build an object-size histogram during Phase 1.
/// Buckets are stored in <see cref="HeapIndexBuildResult.GlobalSizeBuckets"/> (long[8]).
/// </summary>
/// <remarks>
...
///   [7]  ≥ 1 048 576 B     LOH large (≥ 1 MB)
/// </remarks>
internal static class SizeBucketHelper
{
    public const int BucketCount = 8;

    // Upper bounds (exclusive). Index 7 has no upper bound (catch-all).
