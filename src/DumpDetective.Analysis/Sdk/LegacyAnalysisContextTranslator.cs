...
/// populates <c>HeapTypeStatistics</c> — the one capability the retyping pilot's analyzer needs; see
/// docs/refactor/modularity/phase-1-full-extraction-retyping-plan.md. Every other capability-scoped
/// property on the built context is left null, which is correct here (not merely incomplete): no
/// migrated analyzer needs them yet, and the SDK context's own contract already treats null as "not
