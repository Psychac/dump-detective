    ...
    internal sealed class HeapTopologyTrendComparer : IAnalyzerTrendComparer
    {
        ...
        public IReadOnlyList<AnalyzerMetric> ExtractMetrics(AnalyzerDomainResult result)
        {
            ...
            [
                ...
                new("segment.soh.bytes", null, r.SohBytes, "bytes", MetricTrendDirection.HigherIsWorse),
        ...
        public IReadOnlyList<MetricDelta> Compare(AnalyzerDomainResult baseline, AnalyzerDomainResult current)
        {
            ...
            [
                ...
                MetricDeltaHelper.Compute("segment.soh.bytes", null, b.SohBytes, c.SohBytes, "bytes", MetricTrendDirection.HigherIsWorse),
