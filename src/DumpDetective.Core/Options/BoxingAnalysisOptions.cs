...
public sealed class BoxingAnalysisOptions
{
    ...
    public int TopOversizedTypeLimit { get; init; } = 20;
    ...
    {
        AnalysisProfile.Fast => new BoxingAnalysisOptions { TypeScanCap = 5_000, TopBoxedTypeLimit = 10, TopPaddingLimit = 10, TopOversizedTypeLimit = 10, OversizedThresholdBytes = 96 },
        AnalysisProfile.Full => new BoxingAnalysisOptions { TypeScanCap = 50_000, TopBoxedTypeLimit = 50, TopPaddingLimit = 50, TopOversizedTypeLimit = 50, OversizedThresholdBytes = 48 },
