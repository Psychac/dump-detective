...
internal sealed class LockGraphFindingGenerator : IFindingGenerator
{
    ...
    public IReadOnlyList<InsightFinding> Generate(AnalyzerDomainResult result)
    {
        ...
        FindingSeverity severity = r.ContestedLockCount > 0 ? FindingSeverity.Warning
        ...
        [
            new InsightFinding(
                ...
                Evidence: evidence,
                Recommendation: r.DeadlockCandidateCount >= 2
                    ? "Potential deadlock pattern detected. Review lock acquisition order and use cycle detection tools (e.g., !dlk in WinDbg) to confirm circular-wait."
