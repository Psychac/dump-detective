...
public sealed class AppDomainAnalyzerDiscrepancyTests
{
    ...
    [Fact]
    public async Task AppDomainAnalyzer_DiskVsMemoryMode_AgreeOnSameHeap()
    {
        ...
        AppDomainAnalyzer analyzer = new();
        ...
        AppDomainDomainResult memResult = (AppDomainDomainResult)await analyzer.AnalyzeAsync(memContext, CancellationToken.None);
        string freshDumpPath = dumpPath + ".freshdiskcheck.AppDomainAnalyzerDiscrepancyTests";
