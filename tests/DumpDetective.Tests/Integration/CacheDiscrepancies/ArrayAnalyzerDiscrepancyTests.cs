...
public sealed class ArrayAnalyzerDiscrepancyTests
{
    ...
    [DiscrepancyFact]
    public async Task ArrayAnalyzer_DiskVsMemoryMode_AgreeOnSameHeap()
    {
        ...
        ArrayDomainResult memResult = (ArrayDomainResult)await analyzer.AnalyzeAsync(memContext, CancellationToken.None);
        string freshDumpPath = dumpPath + ".freshdiskcheck.ArrayAnalyzerDiscrepancyTests";
