...
public sealed class LockGraphAnalyzerDiscrepancyTests
{
    ...
    [Fact]
    public async Task LockGraphAnalyzer_DiskVsMemoryMode_AgreeOnSameHeap()
    {
        ...
        LockGraphDomainResult memResult = (LockGraphDomainResult)await analyzer.AnalyzeAsync(memContext, CancellationToken.None);
        string freshDumpPath = dumpPath + ".freshdiskcheck.LockGraphAnalyzerDiscrepancyTests";
