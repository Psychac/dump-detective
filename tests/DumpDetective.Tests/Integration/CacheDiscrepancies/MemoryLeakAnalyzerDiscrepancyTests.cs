...
public sealed class MemoryLeakAnalyzerDiscrepancyTests
{
    ...
    [Fact]
    public async Task MemoryLeakAnalyzer_DiskVsMemoryMode_AgreeOnSameHeap()
    {
        ...
        RetentionAnalyzer analyzer = new();
        ...
        RetentionDomainResult memResult = (RetentionDomainResult)await analyzer.AnalyzeAsync(memContext, CancellationToken.None);
        string freshDumpPath = dumpPath + ".freshdiskcheck.MemoryLeakAnalyzerDiscrepancyTests";
        ...
        try
        {
            ...
            RetentionDomainResult diskResult = (RetentionDomainResult)await analyzer.AnalyzeAsync(diskContext, CancellationToken.None);
