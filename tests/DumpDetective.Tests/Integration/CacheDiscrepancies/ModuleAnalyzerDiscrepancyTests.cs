...
public sealed class ModuleAnalyzerDiscrepancyTests
{
    ...
    [Fact]
    public async Task ModuleAnalyzer_DiskVsMemoryMode_AgreeOnSameHeap()
    {
        ...
        ModuleDomainResult memResult = (ModuleDomainResult)await analyzer.AnalyzeAsync(memContext, CancellationToken.None);
        string freshDumpPath = dumpPath + ".freshdiskcheck.ModuleAnalyzerDiscrepancyTests";
